...
EXPECTED_FRAMEWORK_COMMIT = "8274f51b3c56145b4300435cea0d401c47313756"
...
def test_machine_readable_framework_pin_is_valid_and_loaded_exactly() -> None:
    ...
    assert pin["authority"] == (
        "Dependency synchronization to exact clean RAKL origin/main 8274f51b3c56145b4300435cea0d401c47313756 observed 2026-08-12; "
        "the mathematical workflow surfaces are tree-identical to prior pin 43897d3afaf0038385102d5acc64793c05ec40f0, while intervening changes are publication/terminal-receipt artifacts; "
