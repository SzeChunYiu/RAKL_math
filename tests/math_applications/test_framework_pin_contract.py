...
EXPECTED_FRAMEWORK_COMMIT = "34e0e24844dfb322eae3a5c639adc12713065f54"
...
def test_machine_readable_framework_pin_is_valid_and_loaded_exactly() -> None:
    ...
    assert pin["authority"] == (
        "Dependency synchronization to exact clean RAKL origin/main 34e0e24844dfb322eae3a5c639adc12713065f54 observed 2026-08-11; "
