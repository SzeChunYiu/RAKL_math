...
def test_hm1_first_hodge_motives_packet_passes_all_pre_candidate_gates() -> None:
    context_raw = _load("01_frontier/HM1_CONTEXT_FIBER_20260811.json")
    ...
    tools_raw = _load("07_memory/HM1_RESEARCH_TOOL_INVENTORY_20260811.json")
    failures_raw = _load("07_memory/HM1_FAILURE_EXPERIENCE_LATTICE_20260811.json")
    memory_raw = _load("07_memory/HM1_RESEARCH_MEMORY_REVIEW_20260811.json")
    ...
    trace_raw = _load("09_trace/HM1_PRE_CANDIDATE_TRACE_20260811.json")
    previous = ""
    entries = []
    ...
    plan = plan_math_research(
        signature=ProblemSignature(
            ...
            relations=(
                "cycle class map",
                "Betti/Hodge realization",
                "motivic/categorical correspondence realization",
            ),
            domain="complex algebraic geometry / Hodge theory / motives",
            goal_type="audit a realization-to-algebraicity bridge",
        ),
