...
def test_o9d12a2a1a_joint_consistency_pre_candidate_packet_passes_current_gates() -> None:
    context_raw = _load("01_frontier/O9d12a2a1a_CONTEXT_FIBER_20260811.json")
    ...
    tools_raw = _load("07_memory/O9d12a2a1a_RESEARCH_TOOL_INVENTORY_20260811.json")
    failures_raw = _load("07_memory/O9d12a2a1a_FAILURE_EXPERIENCE_LATTICE_20260811.json")
    memory_raw = _load("07_memory/O9d12a2a1a_RESEARCH_MEMORY_REVIEW_20260811.json")
    ...
    plan = plan_math_research(
        signature=ProblemSignature(
            objects=("cover graph", "integral pair family", "joint consistency state"),
            relations=("semi-filter preservation", "simultaneous pair choice", "cyclic fusion"),
            domain="complexity theory / graph cover complexity",
            goal_type="repair a correlation-sensitive lower-bound representation",
        ),
