...
def test_r13_retrospective_math_scope_and_interfaces_are_exact() -> None:
    ...
    assert audit["subject"] == {
        ...
        "latest_main_audited": "fd7efabd201ae6da3d255074573cac7d584c0518",
        "framework_pin_audited": "43897d3afaf0038385102d5acc64793c05ec40f0",
    }
    assert audit["successor_scope"] == {
        "source_pull_request": 240,
        "source_pull_request_preserved_as_draft": True,
        "carrier": "AUDIT_RECEIPT_AND_TESTS_ONLY",
        "imports_original_candidate_artifacts": False,
        "mathematical_use": "The bounded derivation may guide retrospective work, but this successor grants no strict discovery authority.",
    }
