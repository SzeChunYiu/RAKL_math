...
def test_o9d12a2a1_first_post_hardening_packet_passes_all_pre_candidate_gates() -> None:
    context_raw = _load("01_frontier/O9d12a2a1_CONTEXT_FIBER_20260811.json")
    ...
    tools_raw = _load("07_memory/O9d12a2a1_RESEARCH_TOOL_INVENTORY_20260811.json")
    failures_raw = _load("07_memory/O9d12a2a1_FAILURE_EXPERIENCE_LATTICE_20260811.json")
    memory_raw = _load("07_memory/O9d12a2a1_RESEARCH_MEMORY_REVIEW_20260811.json")
    ...
    trace_raw = _load("09_trace/O9d12a2a1_PRE_CANDIDATE_TRACE_20260811.json")
    previous = ""
    entries = []
    ...
    plan = plan_math_research(
        signature=ProblemSignature(
            objects=("cyclic intersection program", "set-family potential"),
            relations=("free union", "counted binary intersection", "fixed-point reuse"),
            domain="complexity theory / graph cover complexity",
            goal_type="discover a lower-bound invariant",
        ),
