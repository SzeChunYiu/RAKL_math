...
def test_xm001_pre_candidate_packet_passes_current_strict_gates() -> None:
    context_raw = _load("01_frontier/XM001_CONTEXT_FIBER_20260811.json")
    ...
    tools_raw = _load("07_memory/XM001_TOOL_SNAPSHOT_20260811.json")
    failures_raw = _load("07_memory/XM001_FAILURE_SNAPSHOT_20260811.json")
    memory_raw = _load("07_memory/XM001_RESEARCH_MEMORY_REVIEW_20260811.json")
    ...
    trace_raw = _load("09_trace/XM001_PRE_CANDIDATE_TRACE_20260811.json")
    previous = ""
    entries = []
    ...
    plan = plan_math_research(
        signature=ProblemSignature(
            objects=("surrogate certificate", "root-lifting map", "root certificate"),
            relations=("relaxation", "limit", "realization", "assembly"),
            domain="cross-Millennium mathematical research methodology",
            goal_type="falsify unsafe surrogate-to-root inference",
        ),
