...
GATE = BASE / "09_trace/O9d12a2a1b_C050_PRE_CANDIDATE_GATE_RECEIPT_20260812.json"
INPUTS = {
    "atomization": BASE / "02_problem_dag/O9d12a2a1b_C050_ATOMIZATION_20260812.json",
    "context": BASE / "01_frontier/O9d12a2a1b_C050_MATH_CONTEXT_FIBER_20260812.json",
    "tool_snapshot": BASE / "07_memory/O9d12a2a1b_C050_TOOL_SNAPSHOT_20260812.json",
    "failure_snapshot": BASE / "07_memory/O9d12a2a1b_C050_FAILURE_SNAPSHOT_20260812.json",
    "memory": BASE / "07_memory/O9d12a2a1b_C050_RESEARCH_MEMORY_REVIEW_20260812.json",
    "transformation_memory": BASE / "07_memory/O9d12a2a1b_C050_OBSTRUCTION_TRANSFORMATION_MEMORY_20260812.json",
    "expert_review": BASE / "08_reviews/O9d12a2a1b_C050_EXPERT_CONTEXT_REVIEW_20260812.json",
    "shortcut_review": BASE / "08_reviews/O9d12a2a1b_C050_OBSTRUCTION_TRANSFORMATION_REVIEW_20260812.json",
    "preservation": BASE / "09_trace/O9d12a2a1b_C050_ROOT_COORDINATE_PRESERVATION_20260812.json",
    "trace": BASE / "09_trace/O9d12a2a1b_C050_PRE_CANDIDATE_TRACE_20260812.json",
    "framework_binding": BASE / "09_trace/O9d12a2a1b_C050_FRAMEWORK_SUBJECT_FREEZE_BINDING_20260812.json",
    "framework_observation": BASE / "09_trace/O9d12a2a1b_C050_FRAMEWORK_SUBJECT_REVALIDATION_20260812.json",
}
...
def audit_packet(root):
    ...
    if gate.get("gate_verdicts",{}).get("licensed_action")!="FREEZE_UNTOUCHED_LATER_K_ALIGNMENT_DISCRIMINATOR_ONLY": errors.append("gate: wrong licensed action")
    ...
    if chronology.get("untouched_target_result_accessed") is not False: errors.append("gate: untouched target access boundary changed")
...
def verify_packet(root):
    ...
    if errors: raise PacketIntegrityError("C050 packet failed: "+"; ".join(errors))
def main(argv=None):
    ...
    print(json.dumps({"status":"PASS","licensed_action":"FREEZE_UNTOUCHED_LATER_K_ALIGNMENT_DISCRIMINATOR_ONLY","k13_quarantined":True,"untouched_target_result_accessed":False},sort_keys=True)); return 0
