#!/usr/bin/env python3
"""Capability-free full-document integrity verifier for C049 pre-candidate state."""
from __future__ import annotations
import argparse, hashlib, json
from pathlib import Path

BASE = Path("research/real_math/millennium/p_vs_np")
GATE = BASE / "09_trace/O9d12a2a1b_C049_PRE_CANDIDATE_GATE_RECEIPT_20260812.json"
INPUTS = {
    "atomization": BASE / "02_problem_dag/O9d12a2a1b_C049_ATOMIZATION_20260812.json",
    "context": BASE / "01_frontier/O9d12a2a1b_C049_MATH_CONTEXT_FIBER_20260812.json",
    "tool_snapshot": BASE / "07_memory/O9d12a2a1b_C049_TOOL_SNAPSHOT_20260812.json",
    "failure_snapshot": BASE / "07_memory/O9d12a2a1b_C049_FAILURE_SNAPSHOT_20260812.json",
    "memory": BASE / "07_memory/O9d12a2a1b_C049_RESEARCH_MEMORY_REVIEW_20260812.json",
    "transformation_memory": BASE / "07_memory/O9d12a2a1b_C049_OBSTRUCTION_TRANSFORMATION_MEMORY_20260812.json",
    "expert_review": BASE / "08_reviews/O9d12a2a1b_C049_EXPERT_CONTEXT_REVIEW_20260812.json",
    "shortcut_review": BASE / "08_reviews/O9d12a2a1b_C049_OBSTRUCTION_TRANSFORMATION_REVIEW_20260812.json",
    "preservation": BASE / "09_trace/O9d12a2a1b_C049_ROOT_COORDINATE_PRESERVATION_20260812.json",
    "trace": BASE / "09_trace/O9d12a2a1b_C049_PRE_CANDIDATE_TRACE_20260812.json",
}
...
def audit_packet(root):
    ...
    if gate.get("gate_verdicts",{}).get("licensed_action")!="FREEZE_EXACT_HK_PK1_OVERLAP_DISCRIMINATOR_ONLY": errors.append("gate: wrong licensed action")
...
def verify_packet(root):
    ...
    if errors: raise PacketIntegrityError("C049 packet failed: "+"; ".join(errors))
def main(argv=None):
    ...
    print(json.dumps({"status":"PASS","licensed_action":"FREEZE_EXACT_HK_PK1_OVERLAP_DISCRIMINATOR_ONLY","target_result_accessed":False},sort_keys=True)); return 0
