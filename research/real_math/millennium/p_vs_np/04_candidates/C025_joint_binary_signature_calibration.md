# C025 — joint binary-signature calibration and first-order capacity ceiling
...
**Authority:** `EXACT_LOCAL_REPRESENTATION_CALIBRATION / PROOF_DRAFT / NO_NOVELTY_CLAIM / ROOT_AUTHORITY_NONE`
...
It does not extend this normalization to arbitrary graphs or arbitrary semi-filter geometries. It also does not test higher-order tuple/intersection/closure state.
...
**Rejected narrowly:** cardinality-only first-order signature capacity is not pursued as the super-log primary invariant.
