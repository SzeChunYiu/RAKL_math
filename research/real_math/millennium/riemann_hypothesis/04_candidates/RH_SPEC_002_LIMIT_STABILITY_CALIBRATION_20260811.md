...
**Authority:** `VERIFIED_KNOWN_ANSWER_LIMIT_CALIBRATION / SOURCE_BOUND_ROUTE_PRUNING / NO_RH_THEOREM / NO_NOVELTY_CLAIM / ROOT_AUTHORITY_NONE`.

**Root:** `OPEN_NO_SOLUTION_CERTIFICATE`.

This is the registered post-gate calibration for `RH-SPEC-002`. It tests convergence-package sufficiency before any source-specific convergence theorem is proposed. The same-context expert cell remains non-independent.
