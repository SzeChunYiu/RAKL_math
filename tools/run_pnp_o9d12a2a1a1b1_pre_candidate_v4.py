#!/usr/bin/env python3
"""Run and bind the O9d12a2a1a1b1 V4 pre-candidate assurance envelope.
...
MACHINE_SCHEMA_PATH = "schemas/pnp-o9d12a2a1a1b1-machine-run-v4.schema.json"
GATE_SCHEMA_PATH = "schemas/pnp-o9d12a2a1a1b1-pre-candidate-gate-v4.schema.json"
MACHINE_RECEIPT_PATH = "receipts/pnp-o9d12a2a1a1b1-machine-run-v4-20260811.json"
GATE_RECEIPT_PATH = "receipts/pnp-o9d12a2a1a1b1-pre-candidate-gate-v4-20260811.json"
FOCUSED_LOG_PATH = "receipts/logs/pnp-o9d12a2a1a1b1-focused-v4-20260811.log"
FULL_LOG_PATH = "receipts/logs/pnp-o9d12a2a1a1b1-full-v4-20260811.log"
...
FOCUSED_COMMAND = (
    ...
    "-k pnp_o9d12a2a1a1b1_pre_candidate_v4"
)
FULL_COMMAND = (
    "PYTHONDONTWRITEBYTECODE=1 PYTHONNOUSERSITE=1 PYTHONINTMAXSTRDIGITS=0 "
    "python tools/run_application_tests.py --framework framework/RAKL"
...
# Every byte that the V4 focused test treats as an input is fixed here.  The
...
TESTED_INPUTS: tuple[tuple[str, str], ...] = (
    ...
    ("tests/math_applications/test_pnp_o9d12a2a1a1b1_pre_candidate_v4.py", "FOCUSED_TEST"),
    ("tools/run_pnp_o9d12a2a1a1b1_pre_candidate_v4.py", "ASSURANCE_RUNNER"),
)
...
def audit_machine_semantics(receipt: object) -> dict[str, Any]:
    ...
    expected = (
        ("FOCUSED_V4_GATE_PRE_RECEIPT", FOCUSED_COMMAND, FOCUSED_LOG_PATH),
...
def build_machine_receipt(subject_commit: str, *, recorded_at: str | None = None) -> dict[str, Any]:
    ...
    focused = _run_and_log("FOCUSED_V4_GATE_PRE_RECEIPT", FOCUSED_COMMAND, FOCUSED_LOG_PATH)
    full = _run_and_log("EXACT_APPLICATION_SUITE_PRE_RECEIPT", FULL_COMMAND, FULL_LOG_PATH)
    receipt: dict[str, Any] = {
        "schema_version": "rakl-math-pnp-machine-run-v4",
        "receipt_id": "RAKL-MATH-PNP-O9d12a2a1a1b1-MACHINE-RUN-V4-20260811",
        "atom_id": ATOM,
...
def audit_historical_supersession() -> dict[str, Any]:
    ...
    documents = (v0_failure, v2_failure, v0_gate, v2_gate, v3_machine, v3_gate)
...
def audit_gate_bindings(gate: object, machine: object) -> dict[str, Any]:
    """Cross-bind every semantically load-bearing V4 gate field to executable bytes."""
    ...
    expected_pass = {"verdict": "PASS", "reasons": ["runtime_reconstructed_in_focused_v4_test"]}
...
def build_gate_receipt(*, recorded_at: str | None = None) -> dict[str, Any]:
    ...
    receipt: dict[str, Any] = {
        "schema_version": "rakl-math-pnp-pre-candidate-gate-v4",
        "receipt_id": "RAKL-MATH-PNP-O9d12a2a1a1b1-PRE-CANDIDATE-GATE-V4-20260811",
        "atom_id": ATOM,
        ...
        "runtime_gate": {
            ...
            "context_gate": {"verdict": "PASS", "reasons": ["runtime_reconstructed_in_focused_v4_test"]},
            "memory_gate": {"verdict": "PASS", "reasons": ["runtime_reconstructed_in_focused_v4_test"]},
            "trace_gate": {"verdict": "PASS", "reasons": ["runtime_reconstructed_in_focused_v4_test"]},
            "plan_math_research": {
